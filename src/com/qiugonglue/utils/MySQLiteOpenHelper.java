...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
	private final static String DB_NAME = "db_gonglue.db";
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("create table if not exists tb_place(_id integer primary key autoincrement,  board_id, name, create_time )");
	}
